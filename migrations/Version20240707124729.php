 ...
 */
final class Version20240707124729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, entreprise_id INT NOT NULL, numero INT NOT NULL, date DATE NOT NULL, many_to_one VARCHAR(255) NOT NULL, INDEX IDX_FE86641019EB6921 (client_id), INDEX IDX_FE866410A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
